...
public class EmployeeController {
	...
	// otherwise Spring will not know how to parse date from date to String and vice
	// versa
	...
	// After execution of this Method empObj will be put up in session scope as it
	// mentioned in @SessionAttributes
	...
	public ModelAndView loadUpdateEmployee2(@ModelAttribute("empObj") EmployeeBean EmployeeBean) throws Exception {
		...
		// If you want to display the deleted employee ID on the success page, uncomment below line
		//modelAndView.addObject("empObj2", employee2);
		return modelAndView;
	}

	// After execution of this Handler empObj2 will be put up in session scope as it
	// mentioned in @SessionAttributes
	@RequestMapping(value = "/UpdateEmployee", method = RequestMethod.POST)
	public ModelAndView updateEmployee(@ModelAttribute("empObj2") EmployeeBean EmployeeBean, Model model)
			throws Exception {
	...
	// Define a method to delete the employee details for given employeeId
	@RequestMapping(value = "/LoadDeleteEmployee", method = RequestMethod.GET)
	public ModelAndView loadDeleteEmployee() throws Exception{
		ModelAndView modelAndView = new ModelAndView();
	...
	// After execution of above method, empObj will be put to the below method
	@RequestMapping(value = "/DeleteEmployee", method = RequestMethod.POST)
	public ModelAndView DeleteEmployee(@ModelAttribute("empObj") EmployeeBean EmployeeBean) throws Exception {

		EmployeeBean employee = employeeService.getEmployeeDetails(EmployeeBean.getId());
		EmployeeBean employee2 = employeeService.deleteEmployeeDetails(employee.getId());
		ModelAndView modelAndView = new ModelAndView();
		modelAndView.setViewName("DeleteEmployeeSuccess");
		modelAndView.addObject("empObj2", employee2);
		return modelAndView;
	}
